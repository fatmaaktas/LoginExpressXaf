...
namespace testTest.Blazor.Server {
    public partial class testTestBlazorApplication : BlazorApplication {
        public testTestBlazorApplication() {
            InitializeComponent();
        }
        ...
        private void testTestBlazorApplication_DatabaseVersionMismatch(object sender, DatabaseVersionMismatchEventArgs e) {
#if EASYTEST
            e.Updater.Update();
            e.Handled = true;
#else
